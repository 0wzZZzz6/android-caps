...
public class TabItemDetailsActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager linearLayout_chips = new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false);
        recyclerViewChips.setLayoutManager(linearLayout_chips);
